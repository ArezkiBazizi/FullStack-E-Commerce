				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<?php
							...
							$orders_list = "SELECT o.order_id,o.user_id,o.product_id,o.qty,o.total,o.p_status,p.product_title,p.product_price,p.product_image FROM orders o,products p WHERE o.user_id='$user_id' AND o.product_id=p.product_id";
